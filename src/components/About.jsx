...
const About = () => {
  return (
    <div
      className='max-w-[1300px] mx-auto p-8 grid md:grid-cols-2 gap-8 place-items-center'
      id='about'>
      ...
      <div className='p-6'>
        ...
        Lulusan Sistem Informasi dengan keahlian dalam pengembangan perangkat lunak, manajemen basis data, analisis sistem, dan manajemen proyek TI. Terampil dalam PHP, JavaScript, dan framework Laravel, serta memiliki pengalaman langsung dalam membangun aplikasi web yang skalabel. Menguasai integrasi sistem informasi dalam proses bisnis, perancangan arsitektur sistem, dan analisis kebutuhan pengguna untuk memberikan solusi teknologi yang efektif. Memahami metodologi SDLC (System Development Life Cycle) dan berkomitmen pada kerja tim, pemecahan masalah, serta pengembangan diri di bidang teknologi informasi.
        </p>
