    ...
    <div className="flex text-2xl justify-between text-gray-200 items-center px-6 max-w-[1300px] mx-auto h-24">
      ...
      <ul className="hidden md:flex gap-12 z-10 cursor-pointer">
        <li className="relative group">
          ...
          <span className="absolute bottom-0 left-0 w-full h-1 bg bg-sky-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out"></span>
        </li>
        <li className="relative group">
      ...
      <div className={nav ? 'text-center z-20 fixed h-full w-full left-0 top-0 bg-[#232323]' : 'fixed left-[-100%]'}>
        <ul className=" font-semibold text-4xl space-y-8 mt-24">
          ...
          <li>
          <Link to="portofolio" onClick={closeNav} smooth={true} offset={50} duration={500}>Portofolio</Link>
          </li>
          <li>
